...
export default function Dashboard() {
    ...
    const fetchNotes = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        try {
            setLoading(true);
            const res = yield axios.get('/api/notes', {
    ...
    const fetchUser = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    const handleAddOrUpdateNote = () => __awaiter(this, void 0, void 0, function* () {
        if (!title.trim() || !content.trim())
            return;
        try {
            setLoading(true);
            if (editingId) {
                yield axios.put(`/api/notes/${editingId}`, { title, content }, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                setEditingId(null);
            }
            else {
                yield axios.post('/api/notes', { title, content }, {
                    headers: { Authorization: `Bearer ${token}` },
                });
            }
            setTitle('');
